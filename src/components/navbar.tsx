export default function Navbar() {
 return (
  <nav class='sticky top-0 flex h-[42px] items-center justify-between border-b-[1px] border-b-[var(--bg-border-secondary)] bg-[var(--bg-secondary)] p-4 text-white'>
   ...
   >
    <li>
     <a href='https://github.com/aryxst/ropasses' class='rounded-lg p-2 font-bold transition-colors hover:bg-[var(--bg-tertiary)]' target='_blank' rel='noopener noreferrer prefetch'>
      Source Code
     </a>
    </li>
   </ul>
